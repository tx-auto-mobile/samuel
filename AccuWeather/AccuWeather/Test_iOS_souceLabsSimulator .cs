...
{
    class Test_iOS_souceLabsSimulator
    {
        ...
        public void Class1()
        {
            ...
            capabilities.SetCapability("username", "samuelin");
            capabilities.SetCapability("accessKey", "529a360d-3862-4baa-89a0-449c066dcc60");
